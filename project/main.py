...
if __name__ == "__main__":
    ...
    # Experiment
    p.add_argument("--name", "-n", type=str, default="0001 - Pretrained ResNet18 Grouped", help="Experiment name")
    ...
    p.add_argument("--run_id", "-rid", type=str, default="3vm7ke8k", help="Wandb run ID for continuing experiment")
