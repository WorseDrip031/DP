...
if __name__ == "__main__":
    ...
    # Experiment
    p.add_argument("--name", "-n", type=str, default="0005 - Pretrained Frozen ViT Grouped Downscale", help="Experiment name")
    ...
    p.add_argument("--use_frozen_model", "-ufm", choices=["Yes", "No"], default="Yes", help="Use frozen model?")
